...
class Publishing:
    ...
    def set_publisher_name(self, val):
        ...
        e = Exception('publishing_model.set_publisher_name.unsupported_datatype')
        ErrorLogger.error(f'product_model.set_publisher_name.unsupported_datatype. Details: {str({"publisher_name_type": type(self.publisher_name), "value_type": type(val)})}')
        return e
